...
class Menu:
    ...
    def create_buttons(self):
        ...
        self.tile_button_rect = self.generic_button_rect.copy().inflate(-button_margin, -button_margin)
        self.coin_button_rect = self.generic_button_rect.move(self.rect.height / 2, 0).inflate(-button_margin, -button_margin)
        self.enemy_button_rect = self.generic_button_rect.move(self.rect.height / 2, self.rect.width / 2).inflate(-button_margin, -button_margin)
        self.palm_button_rect = self.generic_button_rect.move(0, self.rect.width / 2).inflate(-button_margin, -button_margin)
    ...
    def hightlight_indicator(self, index):
    ...
    def display(self, index):
        ...
        self.hightlight_indicator(index)
