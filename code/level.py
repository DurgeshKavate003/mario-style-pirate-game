...
class Level:
	...
	def get_coins(self):
		collide_coins = pygame.sprite.spritecollide(self.player, self.coin_sprites, True)

		for sprite in collide_coins:
...
class CameraGroup(pygame.sprite.Group):
	...
	def draw_horizon(self):
		...
		if horizon_pos < WINDOW_HEIGHT:
			...
			pygame.draw.line(self.display_surface, HORIZON_COLOR, (0, horizon_pos), (WINDOW_WIDTH, horizon_pos), 2)
